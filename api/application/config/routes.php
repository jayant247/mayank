...
$route['api/users/profileDemo'] = 'api/users/profileDemo';

$route['api/users/profile'] = 'api/users/profile';
$route['api/users/updateChatDevice'] = 'api/users/chatDevice';
$route['api/users/getChatDevice'] = 'api/users/getChatDevice';

// $route['api/users/chatDevice'] = 'api/users/chatDevice';
$route['api/users/id/(:num)'] = 'api/users/users/id/$1';



$route['api/users/registeredProfile'] = 'api/users/registeredProfile';
$route['api/users/purchase'] = 'api/users/purchase';
